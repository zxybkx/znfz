...
class Workplace extends PureComponent {
  ...
  callback = (key) => {
    ...
    this.refs['BazqChart'].childMethod()
  }
        ...
        <Col xl={24} lg={24} md={24} sm={24} xs={24}>
          <div className={classnames(styles.currentbtn)}>
            <button
              ...
              onClick={this.callback.bind(this, 1)}>审查逮捕
            </button>
            <button
              className={this.state.munu == 2 ? classnames(styles.ac) : ''}
              onClick={this.callback.bind(this, 2)}>审查起诉
            </button>
          </div>
                 ...
                 <span className={styles.count}
                       onClick={() => {
                         ...
                         dispatch(routerRedux.push({
                           pathname: path,
                           query: {ysay: 'all', zt: 1, startTime: '2018-01-01'}
                         }));
                       }}>
                  ...
                  {ajlb === 'GS' ?
                    ...
                    <span className={styles.count}
                          onClick={() => {
                            dispatch(routerRedux.push({
                              pathname: `/zcjd`,
                              query: {ysay: 'all', zt: -1, startTime: '2019-01-01'}
                            }));
                          }}>
                    {baqkList && baqkList['办案情况'] ? baqkList['办案情况'][0]['案件总数'] : 0}
                  </span>
          ...
          <Row gutter={16} className={classnames(styles.leftMain, 'left-main')}>
            ...
            {/* 在线办案时长 */}
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <BazqChart ref='BazqChart' {...bazqchart} />
            </Col>
            {/* 侦察监督 */}
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <ZcjdChart  {...zcjdchart} />
